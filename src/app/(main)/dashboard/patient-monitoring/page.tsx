    ...
    >
      <div className="grid min-h-10 grid-cols-[minmax(0,1fr)_auto] items-center gap-x-4 gap-y-2 px-2 py-2 text-sm lg:grid-cols-[minmax(0,1fr)_auto_minmax(0,1fr)] lg:py-0">
        ...
        <div className="col-span-2 flex items-center justify-between gap-5 text-muted-foreground lg:col-span-1 lg:justify-end">
          ...
          <TooltipTrigger>
            <button aria-label="Alarm audio enabled" className="inline-flex" type="button">
              <Volume2 aria-hidden="true" className="size-4" />
            </button>
            <Tooltip>Alarm audio enabled</Tooltip>
          </TooltipTrigger>
          <TooltipTrigger>
            <button aria-label="Monitoring network connected" className="inline-flex" type="button">
              <Network aria-hidden="true" className="size-4" />
            </button>
            <Tooltip>Monitoring network connected</Tooltip>
          </TooltipTrigger>
        </div>
      </div>
      <Separator />
