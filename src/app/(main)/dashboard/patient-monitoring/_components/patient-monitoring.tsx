  ...
  return (
    <div className="grid min-w-0 flex-1 lg:grid-cols-[20rem_minmax(0,1fr)]">
      ...
      <div className="flex min-w-0 flex-col border-border lg:border-l">
        ...
        <Tabs className="min-h-0 flex-1 gap-0" defaultSelectedKey="trends">
          <TabsList
            ...
            variant="line"
          >
            <TabsTrigger id="real-time">Real time</TabsTrigger>
            <TabsTrigger id="events">Event review</TabsTrigger>
            <TabsTrigger id="trends">Trends</TabsTrigger>
            <TabsTrigger id="disclosure">Full disclosure</TabsTrigger>
          </TabsList>

          <TabsContent className="m-0 flex flex-col items-center justify-center gap-1 px-4 text-center" id="real-time">
          ...
          <TabsContent className="m-0" id="events">
          ...
          <TabsContent className="m-0" id="trends">
            <PatientTrends patient={selectedPatient} />
          </TabsContent>
          <TabsContent className="m-0 flex flex-col items-center justify-center gap-1 px-4 text-center" id="disclosure">
